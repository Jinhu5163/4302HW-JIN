...
def main():
    ...
    # random layered medium
    medium_type = "random"
    c = build_speed_profile(x, medium_type=medium_type, seed=seed)
    cmax = np.max(c)
    ...
    for nstep in range(1, Nt):
        ...
        # p_next = 2 p_curr - p_prev + dt^2 * lap_vec + dt^2 * source_vec
        p_curr.copy(p_next)
        p_next.scale(2.0)
    ...
    print("Random layered run completed.")
    print("Generated:")
    print("  random_speed.png")
    print("  random_snapshots.png")
    print("  random_receiver_signal.png")
