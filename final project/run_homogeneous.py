...
def main():
    ...
    for nstep in range(1, Nt):
        ...
        if nstep < 5:
            print("nstep =", nstep,
                  "t =", tn,
                  "source =", gaussian_source_value(tn, source_A, source_t0, source_sigma))
    ...
    print("Homogeneous run completed.")
    print("Generated:")
    print("  homogeneous_speed.png")
    print("  homogeneous_snapshots.png")
    print("  homogeneous_receiver_signal.png")
